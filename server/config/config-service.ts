...
const SELECT_COLUMNS =
  ...
  "qris_provider_merchant_id,qris_webhook_secret,qris_auto_retry,subscription_payment_gateway,gateway_fee_percentage,platform_fee_percentage,payout_adjustment_amount,minimum_payout_amount," +
