...
export const SEMANTIC_ROLES: {
  ...
  {
    value: "tutorial.continue",
    label: "Continue -> Package / Template",
    screen: "tutorial",
  },
  {
    value: "tutorial.back",
...
> = {
  ...
  "preview-media-toggle": { label: "Media View Toggle", icon: Film },
  ...
  "return-countdown": { label: "Auto Return Timer", icon: Timer },
  "session-countdown": { label: "Session Timer", icon: Clock },
  "payment-countdown": { label: "Payment Timer", icon: Clock },
...
export const PAGE_COMPONENTS: Record<BuilderPage, BuilderComponentType[]> = {
  ...
  tutorial: ["text", "image", "button", "background-decoration"],
  template: [
    "text",
    "image",
    "button",
