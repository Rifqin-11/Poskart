        ...
        <SettingsPanelBlock>
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex min-w-0 items-center gap-4">
              <div className="relative grid size-20 shrink-0 place-items-center rounded-3xl border border-zinc-200 bg-zinc-950 text-2xl font-semibold text-white shadow-sm">
                {accountInitials || "PO"}
                <button
                  type="button"
              ...
              <div className="min-w-0">
                ...
                <h2 className="mt-1 truncate text-2xl font-semibold text-zinc-950">
                  {accountDisplayName}
                </h2>
